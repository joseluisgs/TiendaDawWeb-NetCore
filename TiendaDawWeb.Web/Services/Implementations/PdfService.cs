...
public class PdfService : IPdfService {
    private const decimal IvaRate = 1.21m; // IVA 21% español
                    ...
                    page.Content()
                        ...
                        .Column(column => {
                            ...
                            column.Item().PaddingBottom(20).Text(text => {
                                text.Line(
                                    $"Nombre: {purchase.Comprador?.Nombre ?? "N/A"} {purchase.Comprador?.Apellidos ?? ""}");
                            ...
                            column.Item().Table(table => {
                                ...
                                // Header
                                table.Header(header => {
                                    header.Cell().Background(Colors.Grey.Lighten2).Padding(5).AlignCenter().Text("#")
                                        .Bold();
                            ...
                            // Totals
                            var subtotal = purchase.Total / IvaRate; // IVA 21%
                            ...
                            column.Item().PaddingTop(20).AlignRight().Column(totalsColumn => {
                                ...
                                totalsColumn.Item().PaddingTop(5).Text(text => {
                                    ...
                                    text.Span($"{purchase.Total:C}").Bold().FontSize(14)
                    ...
                    page.Footer()
                        ...
                        .Column(column => {
                            ...
                            column.Item().PaddingTop(5)
                                .Text("Este documento es una factura simplificada válida para efectos fiscales.")
                                .FontSize(8)
